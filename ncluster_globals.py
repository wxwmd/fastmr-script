...
_should_disble_nas = True


def set_should_disable_nas(val):
  global _should_disble_nas
  if val:
    util.log("disable nas for current user.")
  _should_disble_nas = val

def should_disable_nas():
  return _should_disble_nas
