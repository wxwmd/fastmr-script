...
class Task:
  ...
  def log(self, message, *args, log_level='INFO'):
    ...
    print(f"[{util.current_timestamp()[:-3]} {self.name}{log_level}]# {message}")
...
class Job:
  ...
  def stop(self):
    return self._task_parallel("stop") #, *args, **kwargs)

  def kill(self):
    return self._task_parallel("kill") #, *args, **kwargs)

  def setup(self, *args, **kwargs):
    return self._task_parallel("setup", *args, **kwargs)
